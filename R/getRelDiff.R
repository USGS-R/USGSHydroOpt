#' getRelDiff
#'
#' Computes relative differences from optical data. Assumes that the signal with the greatest 
...
getRelDiff <- function(dataSummary,sigs,grnum,specifyOrder=FALSE,recordOrder=FALSE,ratioVars=FALSE){
